...
define(function (require) {
	...
	[{
          "ContactID": "{{Event.JourneyActivity_testdata.ContactID}}"
        },
        {
          "emailAddress": "{{Event.JourneyActivity_testdata.emailAddress}}"
        },
        {
          "status": "{{Event.JourneyActivity_testdata.status}}"
        }
